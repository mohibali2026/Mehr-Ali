    ...
    <section className="hero">
      ...
      <div style={{
        ...
        <p style={{
          ...
          Mehr Ali is a Germany-based fitness enthusiast and football lover who lives at the crossroads of sport and psychology. He believes that true performance is as much a mental game as a physical one, and that football — like life — is the ultimate teacher.
        </p>
      </div>
    </section>
  )
